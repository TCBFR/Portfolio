...
<body>
    ...
    <div class="container">
        <div class="header">
            ...
            <p>Découvrez tous mes projets réalisés pendants mes stages</p>
        </div>

        <div class="projects-grid">
            <!-- ALF -->
            <div class="project-card" onclick="openModal('landing-page')">
                <div class="project-image Landing-bg"></div>
                <div class="project-content">
                    <h3 class="project-title">Landing Page</h3>
                    <p class="project-description">Création d'une page publicitaire.</p>
                    <div class="tech-tags">
            ...
            <div class="project-card" onclick="openModal('theme-enfant')">
                <div class="project-image Theme-bg"></div>
                <div class="project-content">
                    <h3 class="project-title">Theme enfant sur wordpress</h3>
                    <p class="project-description">Création d'un theme enfant.</p>
                    <div class="tech-tags">
